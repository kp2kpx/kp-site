...
export const LINKS = {
  ...
  // PLACEHOLDER — confirm Telegram handle with KP before relying on it.
  telegram: { label: "Telegram", handle: "@kpx", url: "https://t.me/kpx" },
};
...
export const BUILDS = [
  {
    ...
    // PLACEHOLDER — confirm public GLADAITORS Mini App URL with Arjun.
    url: "",
    urlLabel: "Live URL — coming",
  },
  {
